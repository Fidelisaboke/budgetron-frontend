...
import type {Category, CategoryFormInput} from "@/schemas/category";
import { useState, useEffect } from "react";
import clsx from 'clsx';
import { Paginate } from "@/components/pagination/Paginate";
import { useDebouncedValue } from "@/hooks/useDebouncedValue";
import CategoryFormModal from "@/components/modals/CategoryFormModal.tsx";
...
export default function CategoriesPage() {
    ...
    // Categories form modal properties
    const [isCategoryModalOpen, setIsCategoryModalOpen] = useState(false);
    const [isEditing, setIsEditing] = useState(false);
    const [initialFormData, setInitialFormData] = useState<CategoryFormInput | undefined>(undefined);
    ...
    // Event handler for 'Edit' category button click
    ...
    // 'On Submit' handler for category form
    const handleSubmit = async (formData: CategoryFormInput) => {
        try {
            setIsSubmitting(true);

            // Check if editing or creating a new category
            ...
            // Close the modal and unset the initial form data
        ...
        <>
            <AppLayout title={"Categories"}>
                <div className="w-full flex flex-col sm:flex-row gap-6 mb-4">
                    <Button
                        className="bg-teal-600 hover:bg-teal-700 cursor-pointer focus-visible:ring-2 focus-visible:ring-teal-400 focus-visible:ring-offset-2"
